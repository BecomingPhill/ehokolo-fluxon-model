...
\begin{table}[H]
\centering
\caption{Definitive Multi-Point Concordance of the Full Periodic Table (Representative Subset of the 118 identified elements).}
\label{tab:periodic}
\resizebox{\textwidth}{!}{
\begin{tabular}{@{}llccc@{}}
\toprule
...
\section{Discovery: The Carbon-Nitrogen Fluxonic Isomer Band}

Crucially, the high-sensitivity KDE analysis revealed 114 high-significance peaks that do \textit{not} correspond to any known alpha-process elements or standard isotopes. 

These 114 peaks occupy a densely packed harmonic band between \textbf{11219.51 MeV and 12863.87 MeV}. In the Standard Model, this mass range exists strictly in the gap between Carbon-12 ($\sim 11.17$ GeV) and Nitrogen-14 ($\sim 13.04$ GeV), a region where no stable integer elements can exist under standard chromodynamics.

\begin{table}[H]
\centering
\caption{The Carbon-Nitrogen Fluxonic Isomer Band (Subset of 114 New Resonances)}
\label{tab:isomers}
\resizebox{0.8\textwidth}{!}{
\begin{tabular}{@{}llc@{}}
\toprule
\textbf{Prediction} & \textbf{EFM Predicted Mass (MeV)} & \textbf{Proximity to C-12 Anchor} \\ \midrule
New Resonance 1 & 11219.51 & C-12 + 41.5 MeV \\
New Resonance 2 & 11233.27 & C-12 + 55.3 MeV \\
New Resonance 3 & 11247.06 & C-12 + 69.1 MeV \\
... & ... & ... \\
New Resonance 56 & 11991.70 & C-12 + 813.7 MeV \\
... & ... & ... \\
New Resonance 113 & 12848.95 & C-12 + 1671.0 MeV \\
New Resonance 114 & 12863.87 & C-12 + 1685.9 MeV \\ \bottomrule
\end{tabular}
}
\end{table}

This constitutes the first-principles prediction of a completely new class of matter. Within the EFM, the harmonic transition from $Z=6$ (Carbon) to $Z=7$ (Nitrogen) is not a discrete mathematical jump, but a physical transition across the scalar field's topological landscape. 

We hypothesize that these 114 peaks represent \textbf{Fluxonic Isomers} or stable, exotic hyper-nuclei. They are fractional harmonic states where the scalar field has trapped localized $T/S$ vacuum energy, generating mass states that the Standard Model dismisses as impossible. The extremely tight, periodic spacing of these masses ($\Delta M \approx 14$ MeV between sequential peaks) is the ultimate signature of the EFM's underlying scalar-wave geometry. 
...
def derive_efm_periodic_table_final(checkpoint_path: str):
    ...
    for name, mass in known_elements.items():
        ...
        if accuracy > 95: 
            # Broken into multiple lines for document formatting
